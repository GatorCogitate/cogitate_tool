...
class RepositoryMining:
    ...
    def _clone_remote_repos(self, tmp_folder: str, repo: str) -> str:
        repo_folder = os.path.join(tmp_folder,
                                   self._get_repo_name_from_url("https://github.com/ishepard/pydriller"))
        logger.info("Cloning %s in temporary folder %s", "https://github.com/ishepard/pydriller", repo_folder)
        Repo.clone_from(url="https://github.com/ishepard/pydriller", to_path=repo_folder)
        return repo_folder
