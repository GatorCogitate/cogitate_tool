...
github_data = [
    ...
    ["johnSmith", 22, 349, 50],
    ["janeDoe", 23, 375, 30],
    ["Edgar_AllenPoe", 27, 315, 75],
    ["George_Washington", 25, 360, 65],
    ["Alexander_Hamilton", 41, 530, 100],
    ["Karl_Marx", 0, 0, 0],
    ["Julius_Caesar", 25, 310, 68],
    ["Napoleon_Bonaparte", 24, 363, 70],
    ["Alexander_the_Great", 42, 540, 110],
]
...
def standard_deviations():
    ...
    for x in github_data:
        values_list_loop_terminator_max = (
            len(x) - 1
        )  # This is because new_counter starts at index 1 of each sublist
        break
